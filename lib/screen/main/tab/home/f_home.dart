...
import '../../../../common/widget/mixin/w_big_button.dart';
          ...
          children: [
            RefreshIndicator(
              ...
              child: SingleChildScrollView(
                padding: EdgeInsets.only(top: TtossaAppBar.appBarHeight,bottom: MainScreenState.bottomNavigatorHeight),
                child: Column(
                  children: [
                    BigButton(
                      "토스뱅크",
                      onTap: () {
                        context.showSnackbar("토스 뱅크를 눌렀어요");
                      },
                    ),
                    height10,
                    RoundedContainer(
